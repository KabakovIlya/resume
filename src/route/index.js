  ...
  res.render('summary', {
    ...
    main: {
      summary: {
        ...
        idea of the project. Good teamplayer, every colleague is a friend to me.`,
      },
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      education: [
        {
          name: 'Financial and Economic Lyceum',
          isEnd: true,
        },
        {
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Code editors allow a Developer to write error-free code more efficiently.',
                },
                {
                  name: 'That way, you never need to worry about your code formatting anymore.',
                },
              ],
            },
          ],
